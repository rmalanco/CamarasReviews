    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comments", x => x.ReviewCommentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewModelTagModel", x => new { x.ReviewsReviewId, x.TagsTagId });
                    table.ForeignKey(
                        name: "FK_ReviewModelTagModel_Reviews_ReviewsReviewId",
                        column: x => x.ReviewsReviewId,
                        principalTable: "Reviews",
                        principalColumn: "ReviewId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReviewModelTagModel_Tags_TagsTagId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewModelTagModel_TagsTagId",
