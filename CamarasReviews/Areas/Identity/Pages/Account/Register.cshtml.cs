...
namespace CamarasReviews        .Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(RoleConstants.AuthorRole))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(RoleConstants.AuthorRole));
                    }
